...
export type CameraProtocol='visca-udp'|'visca-tcp'|'visca-serial'|'onvif'|'ndi';
export interface Camera{
 ...
 serialPort?:string;baudRate?:number;viscaIpFraming?:boolean;useSequenceNumbers?:boolean;ndiSource?:string
}
